...
export const AimatedButton: React.FC<PropsWithChildren<AimatedButtonProps>> = ({
  ...
  <button
    type={type}
    disabled={disabled}
    className="cursor-pointer w-56 disabled:cursor-not-allowed rounded-lg text-lg px-6 py-2 overflow-hidden relative group border-2 font-medium border-black text-black disabled:bg-black disabled:opacity-75"
  >
