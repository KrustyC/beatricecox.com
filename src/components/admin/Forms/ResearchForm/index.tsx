...
import { ResearchMaterial } from "@/types/global";
...
interface ResearchFormProps {
  ...
  research?: Research;
  pending?: boolean;
  onSaveResearch: (research: Research) => void;
}

const DEFAULT_RESEARCH: Research = {
  title: "",
  image: "",
  materials: [],
};

const DEFAULT_MATERIAL: ResearchMaterial = {
  name: "",
  type: "",
  date: "",
...
export const ResearchForm: React.FC<ResearchFormProps> = ({
  ...
  return (
    <form
      ...
      onSubmit={handleSubmit(onSaveResearch)}
    >
      ...
      <div className="flex items-center border-t-2 border-slate-300 pt-4 h-24">
        ...
        >
          {pending ? <LoadingSpinner /> : "Save Research"}
        </button>
      </div>
    </form>
  );
